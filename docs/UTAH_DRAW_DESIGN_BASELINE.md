...
| Limited-entry wild turkey | Bonus | Turkey bonus points and bonus drawing | Youth applicants are automatically considered in the up-to-15% youth set-aside and use bonus points there | `engine/utah_draw_predictive/turkey.py` | Implemented with a separate youth set-aside overlay |
