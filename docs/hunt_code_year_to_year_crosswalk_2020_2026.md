...
- Reviewed 2022->2023 sportsman source-gap continuity rows: `11`
...
- `REVIEWED_PRESENT_IN_2023_SPORTSMAN_SOURCE_GAP`: `11`
...
- `2022->2023`: ADDED_NO_PREDECESSOR_CANDIDATE=58, CANDIDATE_SUCCESSOR_BY_IDENTITY=47, DROPPED_NO_SUCCESSOR_CANDIDATE=31, EXACT_CODE_RETAINED=931, REVIEWED_PRESENT_IN_2023_SPORTSMAN_SOURCE_GAP=11
