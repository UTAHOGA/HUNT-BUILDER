...
- Reviewed 2022->2023 sportsman active-continuity rows: `11`
...
- `REVIEWED_SPORTSMAN_ACTIVE_CONTINUITY`: `11`
...
- `2022->2023`: ADDED_NO_PREDECESSOR_CANDIDATE=58, CANDIDATE_SUCCESSOR_BY_IDENTITY=47, DROPPED_NO_SUCCESSOR_CANDIDATE=31, EXACT_CODE_RETAINED=931, REVIEWED_SPORTSMAN_ACTIVE_CONTINUITY=11
