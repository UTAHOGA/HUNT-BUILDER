...
- `utah_materialize_engine` `processed_data/draw_reality_engine.csv`: invalid_numeric_values
- `utah_materialize_engine` `processed_data/draw_reality_view.csv`: missing_required_columns
- `utah_materialize_engine` `processed_data/point_ladder_view.csv`: null_lineage_fields
...
- `utah_materialize_engine` `processed_data/hunt_master_enriched.csv`: null_lineage_fields
...
- `utah_bonus_predictive` `data_truth/draw_results_truth/normalized/draw_results_long.csv`: duplicate_primary_keys, invalid_numeric_values
- `utah_bonus_predictive` `pipeline/RAW/hunt_unit_database/2026/csv/DATABASE.csv`: invalid_nonnegative_integer_values
- `utah_draw_predictive` `processed_data/draw_reality_engine_v2.csv`: duplicate_primary_keys, invalid_numeric_values
- `utah_draw_predictive` `processed_data/draw_reality_engine_predictive_v2.csv`: null_lineage_fields
...
- `utah_draw_predictive` `processed_data/hunt_master_enriched.csv`: null_lineage_fields
- `utah_draw_predictive` `processed_data/hunt_unit_reference_linked.csv`: duplicate_primary_keys, null_lineage_fields
- `utah_draw_predictive` `pipeline/RAW/hunt_unit_database/2026/csv/DATABASE.csv`: invalid_nonnegative_integer_values
...
- `utah_predictive_mixed` `processed_data/draw_reality_engine_predictive_v2.csv`: null_lineage_fields
- `utah_predictive_mixed` `processed_data/point_ladder_view.csv`: null_lineage_fields
- `utah_predictive_mixed` `processed_data/draw_reality_engine.csv`: invalid_numeric_values
...
| BLOCKER | utah_materialize_engine | `processed_data/draw_reality_engine.csv` | 36892 | 0 | invalid_numeric_values |
| BLOCKER | utah_materialize_engine | `processed_data/draw_reality_view.csv` | 53176 | 0 | missing_required_columns |
| BLOCKER | utah_materialize_engine | `processed_data/point_ladder_view.csv` | 91712 | 0 | null_lineage_fields |
...
| BLOCKER | utah_materialize_engine | `processed_data/hunt_master_enriched.csv` | 53225 | 0 | null_lineage_fields |
...
| BLOCKER | utah_bonus_predictive | `data_truth/draw_results_truth/normalized/draw_results_long.csv` | 176753 | 16324 | duplicate_primary_keys, invalid_numeric_values |
| BLOCKER | utah_bonus_predictive | `pipeline/RAW/hunt_unit_database/2026/csv/DATABASE.csv` | 1471 | 0 | invalid_nonnegative_integer_values |
...
| BLOCKER | utah_draw_predictive | `processed_data/draw_reality_engine_v2.csv` | 176753 | 16324 | duplicate_primary_keys, invalid_numeric_values |
| BLOCKER | utah_draw_predictive | `processed_data/draw_reality_engine_predictive_v2.csv` | 26507 | 0 | null_lineage_fields |
...
| BLOCKER | utah_draw_predictive | `processed_data/hunt_master_enriched.csv` | 53225 | 0 | null_lineage_fields |
| BLOCKER | utah_draw_predictive | `processed_data/hunt_unit_reference_linked.csv` | 2997 | 55 | duplicate_primary_keys, null_lineage_fields |
| BLOCKER | utah_draw_predictive | `pipeline/RAW/hunt_unit_database/2026/csv/DATABASE.csv` | 1471 | 0 | invalid_nonnegative_integer_values |
...
| BLOCKER | harvest_quality | `data_model/harvest_quality/harvest_quality_features_all_years_by_hunt_code.csv` | 5563 | 0 | null_lineage_fields |
...
| BLOCKER | harvest_quality | `data_model/harvest_quality/harvest_feature_model_by_hunt_code_2026.csv` | 1411 | 0 | null_lineage_fields |
...
| BLOCKER | utah_predictive_mixed | `processed_data/draw_reality_engine_predictive_v2.csv` | 26507 | 0 | null_lineage_fields |
| BLOCKER | utah_predictive_mixed | `processed_data/point_ladder_view.csv` | 91712 | 0 | null_lineage_fields |
| BLOCKER | utah_predictive_mixed | `processed_data/draw_reality_engine.csv` | 36892 | 0 | invalid_numeric_values |
| BLOCKER | utah_predictive_mixed | `data_model/harvest_quality/harvest_feature_model_by_hunt_code_2026.csv` | 1411 | 0 | null_lineage_fields |
