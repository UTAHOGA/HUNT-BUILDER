...
def _skipped_no_history_row(forecast_year: int) -> dict[str, object]:
    return {
        "family": "PREFERENCE_DEDICATED_HUNTER_DEER",
        "draw_system_type": "PREFERENCE_DEDICATED_HUNTER_DEER",
        ...
        "preference_model_note": "No source history rows were available for dedicated hunter deer; no probability rows were fabricated.",
    }
