...
assert(result.facts.includes('promotion=PARTIAL_FAMILY_PROMOTION_COMPLETE'), 'The certified-core promotion state must remain explicit without implying all-family certification.');
