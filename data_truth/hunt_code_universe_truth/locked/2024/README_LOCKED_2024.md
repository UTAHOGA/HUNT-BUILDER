# Locked 2024 Hunt-Code Universe

Status: `LOCKED_2024_UNTIL_NEXT_YEAR_DATA_ADDED`

No runtime, engine, website, or prediction-output files are changed by this lock.

## Counts

- Official active hunt-code count: `1030`
- Active prediction-scorable codes: `1027`
- Active reference-only codes: `3`
- Full ledger rows, including support/appendix rows: `1218`
- Active-year truth codes: `1030`
...
- DATABASE next-year support codes: `91`
- DATABASE non-scorable reference appendix codes: `97`
- Codes with boundary_id: `1218`
- Active-year truth codes with boundary_id: `1030`
...
- `LOCKED_2024_HUNT_CODE_UNIVERSE_WITH_BOUNDARY_ID.csv`
- `LOCKED_2024_ACTIVE_YEAR_TRUTH_WITH_BOUNDARY_ID.csv`
- `LOCKED_2024_DATABASE_NEXT_YEAR_PERMIT_SUPPORT.csv`
- `LOCKED_2024_DATABASE_NONSCORABLE_REFERENCE_APPENDIX.csv`
- `LOCKED_2024_SOURCE_YEAR_ARTIFACT_ROWS.csv`
- `LOCKED_2024_CANONICAL_LONG_RECONCILIATION.csv`
- `LOCKED_2024_HUNT_CODE_UNIVERSE_SUMMARY.json`
- `README_LOCKED_2024.md`
