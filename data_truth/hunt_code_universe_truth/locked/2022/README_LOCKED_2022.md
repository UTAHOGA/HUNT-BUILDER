# Locked 2022 Hunt-Code Universe

Status: `LOCKED_2022_UNTIL_NEXT_YEAR_DATA_ADDED`
...
- Active prediction-scorable codes: `1020`
- Active reference-only codes: `47`
- Full ledger rows, including support/appendix rows: `1168`
- Active-year truth codes: `1067`
- Canonical yearly codes: `1020`
- Long-file codes: `1020`
- Canonical/long aligned codes: `1020`
- Regulation reference-review codes: `46`
- Draw-result review codes: `1`
- DATABASE next-year support codes: `90`
- DATABASE non-scorable reference appendix codes: `0`
- Codes with boundary_id: `1114`
- Active-year truth codes with boundary_id: `1024`
- Excluded prefix rows: `13`
- Duplicate PDFs skipped: `5`
...
- `LOCKED_2022_HUNT_CODE_UNIVERSE_WITH_BOUNDARY_ID.csv`
- `LOCKED_2022_ACTIVE_YEAR_TRUTH_WITH_BOUNDARY_ID.csv`
- `LOCKED_2022_DATABASE_NEXT_YEAR_PERMIT_SUPPORT.csv`
- `LOCKED_2022_DATABASE_NONSCORABLE_REFERENCE_APPENDIX.csv`
- `LOCKED_2022_SOURCE_YEAR_ARTIFACT_ROWS.csv`
- `LOCKED_2022_EXCLUDED_WATERFOWL_UPLAND_PREFIX_ROWS.csv`
- `LOCKED_2022_CANONICAL_LONG_RECONCILIATION.csv`
- `LOCKED_2022_HUNT_CODE_UNIVERSE_SUMMARY.json`
- `README_LOCKED_2022.md`
