(() => {
  ...
  const FOLDERS = [
    ...
    { id: "harvest", title: "HARVEST REPORTS", description: "Official DWR harvest results and harvested-age measures from 2017 through the current report year.", icon: "./assets/library-icons/elk.png" },
  ...
  const FIXED_PUBLIC_ITEMS = [
    ...
    { folderId: "harvest", title: "Utah 2025 Harvest Report", subtitle: "1,148 official rows: 1,141 current DWR big-game dashboard rows plus 7 turkey rows, with 2025 annual elk, pronghorn and moose age and DWR-reported 2023-2025 averages where available.", href: "./public/hard-copy/harvest-data/2025/Utah_2025_Harvest_Results_UOGA.pdf", type: "pdf", year: "2025", sortOrder: 10 },
    ...
    { folderId: "harvest", title: "Utah 2024 Harvest Report", subtitle: "1,048 official hunt-code rows with annual harvested age and DWR-reported three-year age kept as separate measures.", href: "./public/hard-copy/harvest-data/2024/Utah_2024_Harvest_Results_UOGA.pdf", type: "pdf", year: "2024", sortOrder: 20 },
    { folderId: "harvest", title: "Utah 2023 Harvest Report", subtitle: "1,179 official hunt-code rows with hunt results, effort, success, satisfaction and harvested-age measures where DWR reports them.", href: "./public/hard-copy/harvest-data/2023/Utah_2023_Harvest_Report_UOGA.pdf", type: "pdf", year: "2023", sortOrder: 30 },
    { folderId: "harvest", title: "Utah 2022 Harvest Report", subtitle: "1,050 official hunt-code rows with hunt results, effort, success, satisfaction and harvested-age measures where DWR reports them.", href: "./public/hard-copy/harvest-data/2022/Utah_2022_Harvest_Report_UOGA.pdf", type: "pdf", year: "2022", sortOrder: 40 },
    { folderId: "harvest", title: "Utah 2021 Harvest Report", subtitle: "974 official hunt-code rows from the repaired DWR annual-report package, with harvested age where evidence is available.", href: "./public/hard-copy/harvest-data/2021/Utah_2021_Harvest_Report_UOGA.pdf", type: "pdf", year: "2021", sortOrder: 50 },
    { folderId: "harvest", title: "Utah 2020 Harvest Report", subtitle: "939 official DWR PDF hunt-code rows with hunt results, effort, success and harvested age where evidence is available.", href: "./public/hard-copy/harvest-data/2020/Utah_2020_Harvest_Report_UOGA.pdf", type: "pdf", year: "2020", sortOrder: 60 },
    { folderId: "harvest", title: "Utah 2019 Harvest Report", subtitle: "962 official DWR PDF hunt-code rows with hunt results, effort, success and harvested age where evidence is available.", href: "./public/hard-copy/harvest-data/2019/Utah_2019_Harvest_Report_UOGA.pdf", type: "pdf", year: "2019", sortOrder: 70 },
    { folderId: "harvest", title: "Utah 2018 Harvest Report", subtitle: "936 official DWR PDF hunt-code rows with hunt results, effort, success and harvested age where evidence is available.", href: "./public/hard-copy/harvest-data/2018/Utah_2018_Harvest_Report_UOGA.pdf", type: "pdf", year: "2018", sortOrder: 80 },
    { folderId: "harvest", title: "Utah 2017 Harvest Report", subtitle: "908 official DWR PDF hunt-code rows with hunt results, effort, success and harvested age where evidence is available.", href: "./public/hard-copy/harvest-data/2017/Utah_2017_Harvest_Report_UOGA.pdf", type: "pdf", year: "2017", sortOrder: 90 },
    ...
    { folderId: "draw", title: "2026 Antlerless Draw Results", subtitle: "Complete official Utah DWR / UtahDraws antlerless results with fully populated resident and nonresident point ladders. Short adult and youth ladders share a complete page.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Antlerless_Draw_Results_Compact_Ladders.pdf", type: "pdf", year: "2026", sortOrder: 10 },
    { folderId: "draw", title: "2026 Big Game Draw Results", subtitle: "Complete official Utah DWR / UtahDraws big-game results, including general-season, Dedicated Hunter, limited-entry, and once-in-a-lifetime drawings. Short adult and youth ladders share a complete page.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Big_Game_Draw_Results_Compact_Ladders.pdf", type: "pdf", year: "2026", sortOrder: 20 },
    { folderId: "draw", title: "2026 Black Bear Draw Results", subtitle: "Complete official Utah DWR / UtahDraws black bear hunting and restricted-pursuit results with fully populated resident and nonresident point ladders. Short ladders share a complete page.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Black_Bear_Draw_Results_Compact_Ladders.pdf", type: "pdf", year: "2026", sortOrder: 30 },
    { folderId: "draw", title: "2026 Turkey Draw Results", subtitle: "Complete official Utah DWR / UtahDraws limited-entry turkey results with fully populated adult and youth residency point ladders. Each complete youth/adult pair remains together.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Turkey_Draw_Results_Compact_Ladders.pdf", type: "pdf", year: "2026", sortOrder: 40 },
    { folderId: "draw", title: "2026 Sportsman Draw Results", subtitle: "Complete official Utah DWR / UtahDraws random-draw results for all ten Sportsman species, two complete hunt cards per page in UOGA's dark-topographic header layout.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Sportsman_Draw_Results_Compact_Ladders.pdf", type: "pdf", year: "2026", sortOrder: 50 },
    { folderId: "expo", title: "2026 EXPO Permit Results - Public Summary", subtitle: "All 125 EXPO hunt listings and 200 permits, with winner names and hometowns omitted.", href: "./public/hard-copy/expo-permits/2026/Utah_2026_Hunt_Expo_Permit_Results_Public.pdf", type: "pdf", year: "2026", sortOrder: 10 },
    { folderId: "expo", title: "Official 2026 EXPO Application Statistics", subtitle: "Applicants and tags available by hunt - the official statistics used to evaluate applicant-to-tag draw pressure.", href: "./public/hard-copy/expo-permits/2026/2026_Draw_Application_Statistics_Western_Hunting_Conservation_Expo.pdf", type: "pdf", year: "2026", sortOrder: 20 },
  ...
  const PUBLIC_HUNT_LIBRARY_PDF_PATHS = [
    // The five concise topographic reports above are the visitor-facing
    // 2026 draw-results set. Retained per-package UtahDraws PDFs stay on
    // disk for source lineage and URL compatibility, but are intentionally
    // not listed as a second, inconsistent public document set.
