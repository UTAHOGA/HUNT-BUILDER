(() => {
  ...
  const FIXED_PUBLIC_ITEMS = [
    ...
    { folderId: "draw", title: "2026 Antlerless Draw Results", subtitle: "Complete official Utah DWR / UtahDraws antlerless results with resident and nonresident point ladders in UOGA's light-brown topographic layout.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Antlerless_Draw_Results_UOGA_Topo.pdf", type: "pdf", year: "2026", sortOrder: 10 },
    { folderId: "draw", title: "2026 Big Game Draw Results", subtitle: "Complete official Utah DWR / UtahDraws big-game results, including general-season, Dedicated Hunter, limited-entry, and once-in-a-lifetime drawings, in UOGA's light-brown topographic layout.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Big_Game_Draw_Results_UOGA_Topo.pdf", type: "pdf", year: "2026", sortOrder: 20 },
    { folderId: "draw", title: "2026 Black Bear Draw Results", subtitle: "Complete official Utah DWR / UtahDraws black bear hunting and restricted-pursuit results with resident and nonresident point ladders in UOGA's light-brown topographic layout.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Black_Bear_Draw_Results_UOGA_Topo.pdf", type: "pdf", year: "2026", sortOrder: 30 },
    { folderId: "draw", title: "2026 Turkey Draw Results", subtitle: "Complete official Utah DWR / UtahDraws limited-entry turkey results with resident and nonresident point ladders in UOGA's light-brown topographic layout.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Turkey_Draw_Results_UOGA_Topo.pdf", type: "pdf", year: "2026", sortOrder: 40 },
    { folderId: "draw", title: "2026 Sportsman Draw Results", subtitle: "Complete official Utah DWR / UtahDraws random-draw results for all ten Sportsman species in UOGA's light-brown topographic layout.", href: "./public/hard-copy/draw-results/2026/Utah_2026_Sportsman_Draw_Results_UOGA_Topo.pdf", type: "pdf", year: "2026", sortOrder: 50 },
