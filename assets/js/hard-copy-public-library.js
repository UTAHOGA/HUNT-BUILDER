(() => {
  ...
  const FOLDERS = [
    ...
    { id: "harvest", title: "HARVEST REPORTS", description: "The three most recent Utah DWR harvest years, enhanced with management objectives, hunter experience, and evidence-gated U.O.G.A. hunt-unit quality.", icon: "./assets/library-icons/elk.png" },
  ...
  const FIXED_PUBLIC_ITEMS = [
    ...
    { folderId: "harvest", title: "Utah 2025 Harvest Report", subtitle: "1,148 official rows with DWR objectives, permit utilization, success, days hunted, satisfaction, annual and reported 3-year age, evidence-gated U.O.G.A. unit quality, and clickable Species / Sex and hunting-unit indexes.", href: "./public/hard-copy/harvest-data/2025/Utah_2025_Harvest_Results_UOGA.pdf", type: "pdf", year: "2025", sortOrder: 10 },
    ...
    { folderId: "harvest", title: "Utah 2024 Harvest Report", subtitle: "1,048 official hunt-code rows with DWR objectives, utilization, effort, satisfaction, distinct annual/reported 3-year ages, evidence-gated U.O.G.A. unit quality, and clickable report navigation.", href: "./public/hard-copy/harvest-data/2024/Utah_2024_Harvest_Results_UOGA.pdf", type: "pdf", year: "2024", sortOrder: 20 },
    { folderId: "harvest", title: "Utah 2023 Harvest Report", subtitle: "1,179 official hunt-code rows with DWR objectives, utilization, effort, satisfaction, distinct annual/reported 3-year ages, evidence-gated U.O.G.A. unit quality, and clickable report navigation.", href: "./public/hard-copy/harvest-data/2023/Utah_2023_Harvest_Report_UOGA.pdf", type: "pdf", year: "2023", sortOrder: 30 },
