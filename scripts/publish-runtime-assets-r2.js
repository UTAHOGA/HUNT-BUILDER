...
const CATALOG = [
  ...
  },
  {
    ...
    public_use: true,
    served_live: true,
    notes: 'Predictive mode feed; currently LFS pointer in repo and requires migration.',
  },
  {
  ...
  },
  {
    ...
    public_use: false,
    served_live: false,
    notes: 'Large model output; keep as reference unless explicitly promoted to runtime.',
  },
  {
