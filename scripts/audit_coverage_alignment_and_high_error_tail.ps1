<# 
RUN COVERAGE UNIVERSE ALIGNMENT + HIGH-ERROR TAIL AUDIT
Run from repo root:
  powershell -ExecutionPolicy Bypass -File .\audit_coverage_alignment_and_high_error_tail.ps1
This script is diagnostic only. It does not change predictions, taxonomy, draw_design, or engine routing.
#>
$ErrorActionPreference = "Stop"
$RepoRoot = "C:\Users\tyler\Desktop\GitHub\HUNT-BUILDER"
Set-Location $RepoRoot
$Py = Join-Path $RepoRoot "scripts\audit_coverage_alignment_and_high_error_tail.py"
...
Write-Host "Running coverage alignment and high-error tail audit..."
python $Py

Write-Host ""
Write-Host "Newest diagnostic outputs:"
Get-ChildItem "audits\prediction_blind_backtests\2025_to_2026\diagnostic_phase" -File |
