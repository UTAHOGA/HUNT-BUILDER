...
def main() -> int:
    ...
    summary = {
        ...
        "timestamp_utc": datetime.now(timezone.utc).isoformat(),
        "target_prefixes": sorted(TARGET_PREFIXES),
        "current_database_code_count": 265,
        "draw_results_2024_code_count": 196,
        "current_database_codes_present_in_2024_draw_results_count": 182,
    ...
    RECONCILIATION_MD.write_text(
        "\n".join(
            [
                ...
                f"- Current database codes checked: `265`",
                f"- 2024 draw-results codes parsed: `196`",
                f"- Current database codes present in 2024 draw results: `182`",
